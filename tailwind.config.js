  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow-opportunity': '0 0 24px -3px rgba(249, 115, 22, 0.65)',
        'glow-brand': '0 0 24px -3px rgba(34, 197, 94, 0.5)',
      },
      keyframes: {
        'pulse-subtle': {
      ...
      animation: {
        ...
        'sheet-slide-up': 'sheet-slide-up 0.3s cubic-bezier(0.16, 1, 0.3, 1)',
      }
    },
  },
  plugins: [],
